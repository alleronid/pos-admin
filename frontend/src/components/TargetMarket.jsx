  ...
  const markets = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1562343192-49c7a1a7750f',
    },
    {
      icon: Coffee,
      title: 'Kafe & Kedai Kopi',
      description: 'Kedai kopi rumahan dan kafe kecil',
      image: 'https://images.unsplash.com/photo-1723016611306-a17cf35a36be',
    },
    {
      icon: UtensilsCrossed,
      title: 'Warung Makan',
      description: 'F&B kecil dan usaha makanan',
      image: 'https://images.unsplash.com/photo-1695654687465-6b7940a9f03a',
    },
    {
      icon: ShoppingBag,
      title: 'Usaha Kecil Lainnya',
      description: 'Berbagai jenis UMKM Indonesia',
      image: 'https://images.unsplash.com/photo-1695654690121-d8c56746ee7b',
    },
  ];
