...
return [
    ...
    */
    ...
    'verify_code' => 'SkMtdRZlVoVwEx0K7Dtyo2w5b1duRGtWNDJNSUx3NWN6QVZweXo0TVhrQlQ4N1gra0VyaklnYUlCYjVrbDRCY0NKdnd4TUs0ZHp2S25lSDBycXAxdzlyZFpPa1V1MjN6dGZPbFlBPT0=',
    'verify_rules' => [
        'email' => [
            'rule' => 'required|string',
            'label' => 'Your Email',
    ...
    */
    'update_commands' => [
        ...
        'php artisan db:seed BusinessModulesSeeder --force',
    ...
    'regular_license' => [
        'link' => 'https://codecanyon.net/checkout/from_item/48904023/?license=regular&size=source&ref=pds',
        'price' => 29
    ],
    'extende_license' => [
        'link' => 'https://codecanyon.net/checkout/from_item/48904023/?license=extended&size=source&ref=pds',
        'price' => 99
    ]
];
