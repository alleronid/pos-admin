...
return [
    'permissions' => [
        ...
        'payment-gateway.toggle' => ['super admin'],
        'landing.install' => ['super admin'],
        'landing.store' => ['super admin'],
        ...
        'paytab.success'         => ['admin'],
        'paytab.callback'        => ['admin'],
        'paytab.cancel'          => ['admin'],

        'payment.paypal'         => ['admin'],
        'payment.paypal.success' => ['admin'],
        'payment.paypal.cancel'  => ['admin'],

        'shop-payment-gateway.index'  => ['admin'],
        'shop-payment-gateway.update' => ['admin'],
        'shop-payment-gateway.toggle' => ['admin'],
        'shop-payment.process'        => ['admin'],
        'stripe-intent-create'        => ['admin'],

        'payment.notify' => ['admin'],
        'payment.success'        => ['admin'],
        'payment.cancel'        => ['admin'],
        'payment.initiate'        => ['admin'],
        'orange.money.payment.process' => ['admin'],
        ...
        //User route
        'profile.index' => ['super admin', 'admin','store'],
        'profile.update' => ['super admin', 'admin','store'],
        'user.password' => ['admin', 'super admin','store'],
        //Sale route
        ...
        'settings.theme' => ['admin', 'super admin'],
        'settings.business.modules' => ['admin'],
        'settings.business.modules.update' => ['admin'],
        // Language
        ...
        'shop.category.business.module.update' => ['super admin'],
        //shop route
